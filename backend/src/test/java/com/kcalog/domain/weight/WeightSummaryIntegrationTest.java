...
class WeightSummaryIntegrationTest {
    ...
    void fullSummary() throws Exception {
        member.updateProfile(null, null, new BigDecimal("170"), null, null, new BigDecimal("65"), null);
    ...
    void noLogs() throws Exception {
        member.updateProfile(null, null, null, null, null, new BigDecimal("65"), null);
        memberRepository.save(member);
